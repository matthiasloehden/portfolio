<template>
  ...
  >
    ...
    >
      ...
      <p><span class="code-line">03</span>&nbsp;&nbsp;discipline: <span class="code-string">'full-stack'</span>,</p>
      <p><span class="code-line">04</span>&nbsp;&nbsp;focus: [</p>
      <p><span class="code-line">05</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="code-string">'performance'</span>,</p>
      <p>
        <span class="code-line">06</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="code-string">'maintainability'</span>,
      </p>
      <p><span class="code-line">07</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="code-string">'user experience'</span></p>
